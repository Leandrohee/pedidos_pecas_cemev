...
router.register('pedidos2024', Pedido2024ViewSet, basename='pedidos2024')                      #criando a rota relativa 'pedidos2024/' para acessar o modelo Pedido2024 com o serializer


urlpatterns = [
    path('api_',include(router.urls)),                                                              #essa rota padrao direciona para as rotas relativas criadas usando o viewset
